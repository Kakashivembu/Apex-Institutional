...
const MACRO_ASSETS = [
  { id: 'GOLD.i#', symbol: 'OANDA:XAUUSD', label: 'Gold (GOLD.i#)' },
  ...
  { id: 'US30.i#', symbol: 'FOREXCOM:DJI', label: 'US30 (Dow)' },
  { id: 'AUDUSD.i#', symbol: 'OANDA:AUDUSD', label: 'AUD/USD' }
];
  ...
  return (
    <div className="space-y-8 animate-fade-in pb-12">
      ...
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6 mb-2 min-w-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-4 gap-4 w-full xl:w-auto xl:max-w-[980px]">
