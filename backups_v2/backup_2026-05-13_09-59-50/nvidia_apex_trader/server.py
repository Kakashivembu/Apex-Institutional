            ...
            for trail_key, state in list(step_trail_state.items()):
                ...
                try:
                    ...
                    if response.status_code == 200:
                        ...
                        # GUARDRAIL 2: Validate trap direction against execution semantics.
                        ...
                        if not valid_trap:
                            ...
                            print(f" Trigger: {trigger:.{digits}f} (current: {current_price:.{digits}f})")
                            print(f" Protective SL: {protective_sl:.{digits}f} (current SL: {current_sl:.{digits}f})")
                            continue
