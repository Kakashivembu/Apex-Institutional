...
const MACRO_ASSETS = [
  { id: 'GOLD.i#', label: 'Gold (GOLD.i#)' },
  { id: 'EURUSD.i#', label: 'EUR/USD' },
  { id: 'GBPUSD.i#', label: 'GBP/USD' },
  { id: 'USDJPY.i#', label: 'USD/JPY' },
  { id: 'US30.i#', label: 'US30 (Dow)' },
  { id: 'AUDUSD.i#', label: 'AUD/USD' }
];
